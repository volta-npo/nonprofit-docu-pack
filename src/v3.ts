export const v3 = {
  ...
  "capabilities": [
    "Domain-specific workbench: Funder Document Packet Builder",
    "Operational table: Document inventory",
  ...
  "releaseChecklist": [
    ...
    "Packet Completeness reaches production threshold",
    "Expiry Risk is documented with evidence",
    "Confidentiality Labeling has no unresolved blocker",
    "Funder packet checklist verified",
    "Missing document emails verified",
    "Document inventory CSV verified"
  ],
  "operations": [
