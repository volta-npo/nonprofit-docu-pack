export const v1 = {
    "workbench": "Funder Document Packet Builder",
    "table": "Document inventory",
    "metrics": [
        "Packet Completeness",
        "Expiry Risk",
    ...
    "sampleScenario": "Volta chapter uses Nonprofit DocuPack with Riverside Community Bakery to produce a release-ready v1.0 packet."
};
