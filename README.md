...
**Finance & Grants** · **Repo 14/50** · **No backend. No login. Client data stays local.**
...
**Nonprofit DocuPack** is a polished, local-first open-source tool from Volta's 50-project OSS division. It helps Finance students helping community organizations get funder-ready turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
