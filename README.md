...
### A document readiness checklist and packet builder for small nonprofits applying for funding.
...
[Live app](https://volta-npo.github.io/14-nonprofit-docu-pack/) · [Report an issue](https://github.com/volta-npo/14-nonprofit-docu-pack/issues) · [Volta](https://voltanpo.org)
...
**Nonprofit DocuPack** is a polished, local-first open-source tool from Volta's open-source program. It helps Finance students helping community organizations get funder-ready turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
...
Small nonprofits often lose time hunting for EIN letters, budgets, board lists, and impact docs.

### The niche

Micro nonprofits and community organizations preparing for grants.

### North-star metric

`organizations with complete funder packets`
...
flowchart TD
    ...
    Evidence --> Workbench["Nonprofit DocuPack Document Packet"]
    Workbench --> Score["Funding readiness"]
    Score --> Cert["release certification"]
    Cert --> A1["Funder packet checklist"]
    Cert --> A2["Missing document emails"]
    Cert --> A3["Document inventory CSV"]
...
flowchart LR
    subgraph Modules["First-class modules"]
        M1["Document inventory"]
        M2["Missing-doc request scripts"]
        M3["Board/funder packet outline"]
        M4["Renewal reminders"]
    end
    M1 --> Workbench
    M2 --> Workbench
    M3 --> Workbench
...
sequenceDiagram
    ...
    participant T as Nonprofit DocuPack
...
|---|---|
| **Domain workbench** | A purpose-built document packet interface for a document readiness checklist and packet builder for small nonprofits applying for funding. |
...
|---:|---|---|
| 1 | **Document inventory** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 2 | **Missing-doc request scripts** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 3 | **Board/funder packet outline** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 4 | **Renewal reminders** | Converts field work into repeatable, reviewable Volta delivery evidence. |
...
This release adds a SaaS-grade operating layer so **Nonprofit DocuPack** can stand alone as more than a checklist. It models:
...
```bash
git clone https://github.com/volta-npo/14-nonprofit-docu-pack.git
cd 14-nonprofit-docu-pack
npm install
npm test
