...
from nonprofit_docu_pack_backend.engine import DOMAIN_ROWS, PRODUCT_SLUG, build_release_packet, summarize_rows
...
class ServerModuleTests(unittest.TestCase):
    def test_health_handler_exists(self):
        from nonprofit_docu_pack_backend.server import Handler
